...
// module
exports.push([module.i, ".span-center[data-v-79beffd9]{display:inline-block;width:100%;font-weight:700}.store-dialog[data-v-79beffd9]{width:120%}.grid-content[data-v-79beffd9]{min-height:1px}.el-row[data-v-79beffd9]{margin-bottom:4px;&:last-child{margin-bottom:0}}.el-col[data-v-79beffd9]{border-radius:4px}.span-material[data-v-79beffd9]{margin-right:6px}.form-box[data-v-79beffd9]{width:100%}.el-input[data-v-79beffd9]{width:50%}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('el-row', _vm._l((_vm.allCabinDOList), function(item) {
    return _c('el-col', {
      key: item.cabinCode,
      attrs: {
        "span": 4
