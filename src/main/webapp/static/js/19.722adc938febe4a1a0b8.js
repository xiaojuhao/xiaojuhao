...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted() {
        this.initData();
        __WEBPACK_IMPORTED_MODULE_2__common_bus__["a" /* api */].getAllStoreList().then(stores => {
            stores.forEach(s => {
                let c = {};
        ...
        __WEBPACK_IMPORTED_MODULE_2__common_bus__["a" /* api */].getAllWarehouseList().then(wares => {
            wares.forEach(w => {
                let c = {};
