...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_MaterialSelection__ = __webpack_require__(693);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_MyCabinSelect__ = __webpack_require__(689);
    ...
    methods: {
        ...
        onSelectSpec(item) {
            item.specCodeSel && item.specCodeSel.forEach(it => {
                ...
                //没有规则信息，将第一个规格作为默认规格
                if (!item.specCode) {
                    __WEBPACK_IMPORTED_MODULE_3_vue___default.a.set(item, 'specCode', item.specCodeSel[0].specCode);
                    __WEBPACK_IMPORTED_MODULE_3_vue___default.a.set(item, 'specName', item.specCodeSel[0].specName);
                    __WEBPACK_IMPORTED_MODULE_3_vue___default.a.set(item, 'specUnit', item.specCodeSel[0].specUnit);
                    __WEBPACK_IMPORTED_MODULE_3_vue___default.a.set(item, 'stockUnit', item.specCodeSel[0].stockUnit);
                    __WEBPACK_IMPORTED_MODULE_3_vue___default.a.set(item, 'transRate', item.specCodeSel[0].transRate);
                    __WEBPACK_IMPORTED_MODULE_3_vue___default.a.set(item, 'brandName', item.specCodeSel[0].brandName);
                    __WEBPACK_IMPORTED_MODULE_3_vue___default.a.set(item, 'homeplace', item.specCodeSel[0].homeplace);
                    __WEBPACK_IMPORTED_MODULE_3_vue___default.a.set(item, 'selectedSpec', item.specCodeSel[0]);
                }
            });
