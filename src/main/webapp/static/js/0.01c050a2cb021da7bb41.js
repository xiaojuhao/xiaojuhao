...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_vm._v(_vm._s(item.title))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.content))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.formatDate(item)))])])
  }))]), _vm._v(" "), _c('div', {
    staticStyle: {
      "margin-left": "40px",
      "margin-bottom": "40px"
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        formatDate(item) {
            return __WEBPACK_IMPORTED_MODULE_0__common_bus__["c" /* util */].formatDate(item.gmtCreated);
        }
    },
    mounted() {
