...
// module
exports.push([module.i, ".title[data-v-6eb5e0aa]{width:100%;margin-left:60px}header[data-v-6eb5e0aa],section[data-v-6eb5e0aa]{width:50%}.card[data-v-6eb5e0aa]{width:200px;height:200px;float:left;margin-left:10px;margin-top:10px}.time[data-v-6eb5e0aa]{font-size:13px;color:#999}.bottom[data-v-6eb5e0aa]{margin-top:13px;line-height:12px}.button[data-v-6eb5e0aa]{padding:0;float:right}.image[data-v-6eb5e0aa]{width:100%;height:100%;display:inline}.clearfix[data-v-6eb5e0aa]:after,.clearfix[data-v-6eb5e0aa]:before{display:table;content:\"\"}.clearfix[data-v-6eb5e0aa]:after{clear:both}", ""]);
...
var update = __webpack_require__(199)("97c4c73a", content, true);
