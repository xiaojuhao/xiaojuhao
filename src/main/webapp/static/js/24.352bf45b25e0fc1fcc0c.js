...
var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_c('span', [_c('strong', [_vm._v("仓库：")]), _vm._v(_vm._s(item.cabinName))]), _vm._v(" "), _c('span', [_c('strong', [_vm._v("原料：")]), _vm._v(_vm._s(item.materialName))]), _vm._v(" "), _c('span', [_c('strong', [_vm._v("损失：")]), _vm._v(_vm._s(item.stockAmt) + _vm._s(item.stockUnit))]), _vm._v(" "), _c('span', [_c('strong', [_vm._v("报损人: ")]), _vm._v(_vm._s(item.creatorName))]), _vm._v(" "), _c('span', [_c('strong', [_vm._v("报损时间：")]), _vm._v(_vm._s(item.createTime))]), _vm._v(" "), _c('br'), _vm._v(" "), _c('span', [_c('strong', [_vm._v("损耗原因：")]), _c('font', {
      attrs: {
        "color": "red"
      }
    }, [_vm._v(_vm._s(item.remark))])], 1)]), _vm._v(" "), _c('div', {
      staticStyle: {
        "position": "relative"
      }
