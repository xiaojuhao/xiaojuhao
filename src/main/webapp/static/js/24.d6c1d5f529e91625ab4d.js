...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        formateProdDate(row) {
            return __WEBPACK_IMPORTED_MODULE_0__common_bus__["d" /* util */].formatDate(row.prodDate);
        },
        onSubmit() {
    ...
    mounted() {
        __WEBPACK_IMPORTED_MODULE_0__common_bus__["a" /* api */].queryPurchaseOrderDetailByOrderNum(this.ordernum).then(list => {
            this.details = list;
        });
    }
});
...
// module
exports.push([module.i, ".pop-message[data-v-c7af30d0]{position:fixed;top:80px;width:100%;height:100%;z-index:99998;border:1px solid}.pop-message-sub[data-v-c7af30d0]{width:80%;height:90%;z-index:99999;background:#fff}", ""]);
...
var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" 进销存管理")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("入库")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("采购单" + _vm._s(_vm.ordernum))])], 1)], 1), _vm._v(" "), _c('el-table', {
    staticStyle: {
      "width": "150%"
    },
    attrs: {
