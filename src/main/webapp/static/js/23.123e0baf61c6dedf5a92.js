...
// module
exports.push([module.i, ".pagination[data-v-7235a178]{margin:20px,0;text-align:left}.pop-message[data-v-7235a178]{position:fixed;top:0;width:100%;height:100%;z-index:99998;background:gray}.pop-message-sub[data-v-7235a178]{width:60%;height:75%;margin-left:40px;z-index:99999;background:#fff;border:1px solid}.info-row[data-v-7235a178]{background:red}", ""]);
