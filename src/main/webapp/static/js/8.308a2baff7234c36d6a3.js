...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onSubmit() {
            ...
            jsonp(__WEBPACK_IMPORTED_MODULE_0__common_config_vue___default.a.server + '/addMaterials?canSplit=N&materialName=' + this.$data.form.name, null, function (err, resp) {
                console.log(resp);
            });
        }
    },
