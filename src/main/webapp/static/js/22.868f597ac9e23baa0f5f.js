...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("清空")])], 1)], 1)], 1), _vm._v(" "), _c('el-dialog', {
    staticClass: "dialog",
    attrs: {
      "title": "供应商原料信息"
    },
    model: {
      value: (_vm.isSupplierMaterialDialogShow),
      callback: function($$v) {
        _vm.isSupplierMaterialDialogShow = $$v
      },
      expression: "isSupplierMaterialDialogShow"
    }
  }, [_c('el-row', [_c('el-col', [_c('el-input', {
    attrs: {
      "placeholder": "供应商名称or原料名称"
    },
    model: {
      value: (_vm.supplierMaterialSearchWord),
      callback: function($$v) {
        _vm.supplierMaterialSearchWord = $$v
      },
      expression: "supplierMaterialSearchWord"
    }
  }), _vm._v(" "), _c('br'), _c('br')], 1)], 1)], 1)], 1)
},staticRenderFns: []}
